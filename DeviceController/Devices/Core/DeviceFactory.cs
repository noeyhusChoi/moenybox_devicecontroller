...
public sealed class DeviceFactory : IDeviceFactory
{
    ...
    public DeviceFactory(IEnumerable<IDeviceFactoryContributor>? contributors = null)
    {
        ...
        {
            ["PRINTER"] = (d, t) => new PrinterDriver(d, t),
            ["QR_NEWLAND"] = (d, t) => new QrEM20Driver(d, t),
            ["QR_TOTINFO"] = (d, t) => new QrE200ZDriver(d, t),
            ["IDSCANNER"] = (d, t) => new IdScannerDriver(d, t),
            ["HCDM10K"] = (d, t) => new Hcdm10kDriver(d, t),
            ["HCDM20K"] = (d, t) => new Hcdm20kDriver(d, t),
            ["DEPOSIT"] = (d, t) => new DepositDriver(d, t),
        };
    }
