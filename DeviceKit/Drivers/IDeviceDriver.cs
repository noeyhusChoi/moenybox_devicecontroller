// Abstractions/Ports/IDeviceDriver.cs

namespace DeviceKit.Drivers
{
    /// <summary>인프라 레벨 드라이버 인터페이스(명령/상태)</summary>
    internal interface IDeviceDriver
    {
        string Name { get; }
        string Model { get; }
        ...
        Task<DeviceCommandResponse> ExecuteAsync(DeviceCommandRequest command, CancellationToken ct = default);
    }
}
