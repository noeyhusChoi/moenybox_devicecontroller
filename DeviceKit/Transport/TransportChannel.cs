...
/// </summary>
internal sealed class TransportChannel : IAsyncDisposable
{
    ...
    public TransportChannel(ITransport transport, IFramer? framer = null)
    {
...
/// </summary>
internal sealed class PassthroughFramer : IFramer
{
