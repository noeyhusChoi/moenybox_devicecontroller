...
namespace KIOSK.Infrastructure.Database
{
    ...
    {
        private readonly ILogger<DatabaseService> _logging;
        private readonly string _connectionString;
        private readonly int _timeoutSec;
        private bool _disposed;

        public DatabaseService(ILogger<DatabaseService> logging, string? connectionString = null, int commandTimeoutSeconds = 300)
        {
            _logging = logging;
        ...
        public async Task<bool> CanConnectAsync(CancellationToken ct = default)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logging.LogError(ex, "DB Connection Failed");
                                            ...
                                            CancellationToken ct = default)
        {
            ...
            {
                _logging.LogError(ex, "MySQL Error (Number: {Number})", ex.Number);
            ...
            {
                _logging.LogError(ex, "DB Exception");
                                               ...
                                               CancellationToken ct = default)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logging.LogError(ex, "Transaction Error");
