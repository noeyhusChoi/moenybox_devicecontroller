...
namespace KIOSK.Device.Abstractions
{
    ...
    public enum AlertSource { Status, Connection, System }
    ...
    public record StatusEvent(
        ...
        AlertSource Source = AlertSource.Status);
    ...
    public record StatusSnapshot()
    {
        ...
        public AlertSource AlertScope { get; init; } = AlertSource.Status;    // 스냅샷 알람 범위
        public DateTimeOffset Timestamp { get; init; } = DateTimeOffset.UtcNow; // 상태 시각(UTC 권장)

        public bool HasError => Alerts != null && Alerts.Count > 0 || Health == DeviceHealth.Offline;
    }
}
