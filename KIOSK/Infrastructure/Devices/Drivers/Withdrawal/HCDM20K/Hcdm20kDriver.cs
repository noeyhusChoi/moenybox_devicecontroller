...
public sealed class Hcdm20kDriver : DeviceBase
{
    ...
    {
        if (BitIsSet(data[0], 5)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));
        if (BitIsSet(data[0], 4)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));
        if (BitIsSet(data[0], 3)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));
        if (BitIsSet(data[0], 2)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));
        if (BitIsSet(data[0], 1)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));
        if (BitIsSet(data[0], 0)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_NEAR_END"), string.Empty, Severity.Warning));

        if (BitIsSet(data[3], 5)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));
        if (BitIsSet(data[3], 4)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));
        if (BitIsSet(data[3], 3)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));
        if (BitIsSet(data[3], 2)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));
        if (BitIsSet(data[3], 1)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));
        if (BitIsSet(data[3], 0)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW1"), string.Empty, Severity.Warning));

        if (BitIsSet(data[4], 5)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));
        if (BitIsSet(data[4], 4)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));
        if (BitIsSet(data[4], 3)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));
        if (BitIsSet(data[4], 2)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));
        if (BitIsSet(data[4], 1)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));
        if (BitIsSet(data[4], 0)) alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CASSETTE_SKEW2"), string.Empty, Severity.Warning));

        if (data[6] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "GATE1_DETECTED"), string.Empty, Severity.Warning));
        if (data[7] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "GATE2_DETECTED"), string.Empty, Severity.Warning));
        if (data[9] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "EXIT1_DETECTED"), string.Empty, Severity.Warning));
        if (data[10] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "REJECT_IN_DETECTED"), string.Empty, Severity.Warning));
        if (data[11] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "REJECT_BOX_UNLOCK"), string.Empty, Severity.Warning));
        if (data[12] == '1') alerts.Add(CreateAlert(new ErrorCode("DEV", "WITHDRAWAL", "STATUS", "CIS_OPEN"), string.Empty, Severity.Warning));
    }

    private IReadOnlyDictionary<string, IDeviceCommandHandler> CreateHandlers(Hcdm20kClient client)
        => Hcdm20kCommandHandlers
