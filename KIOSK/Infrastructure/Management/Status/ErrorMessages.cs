...
public sealed class StandardErrorMessageProvider : IErrorMessageProvider
{
    private static readonly IReadOnlyDictionary<string, string> Messages =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["DEV.PRINTER.STATUS.TIMEOUT"] = "프린터 응답이 없습니다. 잠시 후 다시 시도해주세요.",
            ...
            ["DEV.PRINTER.COMMAND.NOT_CONNECTED"] = "프린터가 연결되지 않았습니다.",
            ["DEV.PRINTER.COMMAND.ERROR"] = "프린터 명령 처리에 실패했습니다.",
            ["DEV.PRINTER.COMMAND.TIMEOUT"] = "프린터 명령 응답이 없습니다.",
            ["DEV.PRINTER.COMMAND.UNKNOWN"] = "지원하지 않는 프린터 명령입니다.",

            // QR
            ["DEV.QR.CONNECT.FAIL"] = "QR 스캐너 연결에 실패했습니다.",
            ["DEV.QR.STATUS.ERROR"] = "QR 스캐너 상태에 문제가 발생했습니다.",
            ["DEV.QR.STATUS.TIMEOUT"] = "QR 스캐너 응답이 없습니다. 잠시 후 다시 시도해주세요.",
            ["DEV.QR.COMMAND.NOT_CONNECTED"] = "QR 스캐너가 연결되지 않았습니다.",
            ["DEV.QR.COMMAND.ERROR"] = "QR 스캐너 명령 처리에 실패했습니다.",
            ["DEV.QR.COMMAND.TIMEOUT"] = "QR 스캐너 명령 응답이 없습니다.",
            ["DEV.QR.COMMAND.UNKNOWN"] = "지원하지 않는 QR 스캐너 명령입니다.",

            // ID Scanner
            ["DEV.IDSCANNER.CONNECT.FAIL"] = "신분증 스캐너 연결에 실패했습니다.",
            ["DEV.IDSCANNER.STATUS.ERROR"] = "신분증 스캐너 상태에 문제가 발생했습니다.",
            ["DEV.IDSCANNER.STATUS.TIMEOUT"] = "신분증 스캐너 응답이 없습니다. 잠시 후 다시 시도해주세요.",
            ["DEV.IDSCANNER.COMMAND.NOT_CONNECTED"] = "신분증 스캐너가 연결되지 않았습니다.",
            ["DEV.IDSCANNER.COMMAND.ERROR"] = "신분증 스캐너 명령 처리에 실패했습니다.",
            ["DEV.IDSCANNER.COMMAND.TIMEOUT"] = "신분증 스캐너 명령 응답이 없습니다.",
            ["DEV.IDSCANNER.COMMAND.UNKNOWN"] = "지원하지 않는 신분증 스캐너 명령입니다.",

            // HCDM
            ["DEV.HCDM.CONNECT.FAIL"] = "지폐 방출기 연결에 실패했습니다.",
            ["DEV.HCDM.STATUS.ERROR"] = "지폐 방출기 상태에 문제가 발생했습니다.",
            ["DEV.HCDM.STATUS.TIMEOUT"] = "지폐 방출기 응답이 없습니다. 잠시 후 다시 시도해주세요.",
            ...
            ["DEV.HCDM.COMMAND.NOT_CONNECTED"] = "지폐 방출기가 연결되지 않았습니다.",
            ["DEV.HCDM.COMMAND.ERROR"] = "지폐 방출기 명령 처리에 실패했습니다.",
            ["DEV.HCDM.COMMAND.TIMEOUT"] = "지폐 방출기 명령 응답이 없습니다.",
            ["DEV.HCDM.COMMAND.UNKNOWN"] = "지원하지 않는 지폐 방출기 명령입니다.",

            // Cash (Deposit)
            ["DEV.CASH.CONNECT.FAIL"] = "지폐 투입기 연결에 실패했습니다.",
            ["DEV.CASH.STATUS.ERROR"] = "지폐 투입기 상태에 문제가 발생했습니다.",
            ["DEV.CASH.STATUS.TIMEOUT"] = "지폐 투입기 응답이 없습니다. 잠시 후 다시 시도해주세요.",
            ["DEV.CASH.STATUS.ESCROW_DETECTED"] = "지폐 투입기 에스크로가 감지되었습니다.",
            ["DEV.CASH.STATUS.REJECT_DETECTED"] = "지폐 투입기에서 지폐가 리젝트되었습니다.",
            ["DEV.CASH.COMMAND.STACK_FAIL"] = "지폐 투입기 스택에 실패했습니다.",
            ["DEV.CASH.COMMAND.RETURN_FAIL"] = "지폐 투입기 반환에 실패했습니다.",
            ["DEV.CASH.COMMAND.REJECT_DETECTED"] = "지폐 투입기에서 지폐가 리젝트되었습니다.",
            ["DEV.CASH.COMMAND.NOT_CONNECTED"] = "지폐 투입기가 연결되지 않았습니다.",
            ["DEV.CASH.COMMAND.ERROR"] = "지폐 투입기 명령 처리에 실패했습니다.",
            ["DEV.CASH.COMMAND.TIMEOUT"] = "지폐 투입기 명령 응답이 없습니다.",
            ["DEV.CASH.COMMAND.UNKNOWN"] = "지원하지 않는 지폐 투입기 명령입니다.",

            // Network
            ["NET.DEVICE.CONNECT.FAIL"] = "네트워크 연결에 실패했습니다.",
            ["NET.DEVICE.STATUS.TIMEOUT"] = "장치 응답이 없습니다. 잠시 후 다시 시도해주세요."
        };
