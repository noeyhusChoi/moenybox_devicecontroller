...
namespace KIOSK.Modules.GTF.ViewModels
{
    public partial class GtfLanguageSelectViewModel : ObservableObject, IStepMain, IStepNext, IStepPrevious, IStepError, INavigable
    {
        ...
        public GtfLanguageSelectViewModel(ILocalizationService localizationService, DatabaseCache staticCache, GtfApiService gtfApiService, IGtfTaxRefundService gtfTaxRefundService)
        {
