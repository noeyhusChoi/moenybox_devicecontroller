...
namespace KIOSK.Presentation.Features.Menu.Pages.ViewModels
{
    public partial class MenuViewModel : ObservableObject, IViewLifecycle
    {
            ...
            if (parameter is string param)
            {
                switch (param)
                {
                    case "1":
                        ...
                        break;
                    case "2":
                        await nav.NavigateLayout<MenuV2LayoutViewModel>();
                        break;
                    case "3":
