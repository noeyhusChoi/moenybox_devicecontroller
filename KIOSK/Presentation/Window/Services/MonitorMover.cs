...
namespace KIOSK.Presentation.Window.Services;
...
public static class MonitorMover
{
    ...
    private static (double dx, double dy) GetDipScale(System.Windows.Window w)
    {
    ...
    public static void MoveToScreen(System.Windows.Window w, Screen screen, bool maximize = false, bool useWorkingArea = true)
    {
    ...
    public static Screen GetCurrentScreen(System.Windows.Window w)
    {
    ...
    public static void MoveToNextScreen(System.Windows.Window w, bool maximize = false)
    {
    ...
    public static void MoveActiveWindowToNextScreen(bool maximize = false)
    {
        void Do()
        {
            var w = System.Windows.Application.Current?.Windows.OfType<System.Windows.Window>().FirstOrDefault(win => win.IsActive)
